...
import { ShopTitleEnum, ShopType } from '../types/shop.types'

const SHOP_DATA: ShopType[] = [
  {
    id: 1,
    title: ShopTitleEnum[LinkUrlEnum.HATS],
    routeName: LinkUrlEnum.HATS,
    items: [
      {
        id: 1,
        name: 'Brown Brim',
  ...
  {
    id: 2,
    title: ShopTitleEnum[LinkUrlEnum.SNEAKERS],
    routeName: LinkUrlEnum.SNEAKERS,
    items: [
      {
        id: 10,
        name: 'Adidas NMD',
  ...
  {
    id: 3,
    title: ShopTitleEnum[LinkUrlEnum.JACKETS],
    routeName: LinkUrlEnum.JACKETS,
    items: [
      {
        id: 18,
  ...
  {
    id: 4,
    title: ShopTitleEnum[LinkUrlEnum.WOMENS],
    routeName: LinkUrlEnum.WOMENS,
    items: [
      {
        id: 23,
        name: 'Blue Tanktop',
  ...
  {
    id: 5,
    title: ShopTitleEnum[LinkUrlEnum.MENS],
    routeName: LinkUrlEnum.MENS,
    items: [
      {
        id: 30,
        name: 'Camo Down Vest',
